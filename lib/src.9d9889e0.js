...
runBundler = function (file, opts) {
  ...
  bundler = new _parcelBundler["default"](file, options); // bundler.on('buildStart', (entryFiles)=>{
  //   process.send({
  //     message: 'buildStart',
...
exports.runBundler = runBundler = function (inFile, options = {}) {
  var bundler, bundlerScript;
  bundlerScript = _electron.remote.getGlobal('bundlerScript'); // proc.on 'message', (bundle)=>
