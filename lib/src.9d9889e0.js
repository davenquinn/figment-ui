...
module.exports = {
  "figure-container-outer": "_figure-container-outer_cf4d8",
  "figure-container-inner": "_figure-container-inner_cf4d8",
  "figure-container": "_figure-container_cf4d8",
  "ui-controls": "_ui-controls_cf4d8",
  "ui-controls-hidden": "_ui-controls-hidden_cf4d8",
  "toolbar-toggle-button": "_toolbar-toggle-button_cf4d8",
  "progress": "_progress_cf4d8",
  "fullscreen": "_fullscreen_cf4d8",
  "left-buttons": "_left-buttons_cf4d8",
  "right-buttons": "_right-buttons_cf4d8",
  "linear-progress-bar-stripes": "_linear-progress-bar-stripes_cf4d8",
  "skeleton-glow": "_skeleton-glow_cf4d8",
  "pt-spinner-animation": "_pt-spinner-animation_cf4d8"
};
...
printToPDF = function (webview, opts) {
  return new Promise(function (resolve, reject) {
    ...
    */
    var controls, el, el1, el2, height, oldDisplay, oldMargin, oldPadding, pageSize, scaleFactor, wc, width;
    el = document.getElementsByClassName(_main["default"]["figure-container-inner"])[0];
    el1 = document.getElementsByClassName(_main["default"]["figure-container-outer"])[0];
    el2 = document.getElementsByClassName(_main["default"]["figure-container"])[0];
    ...
    console.log(opts); // This is really trashy
...
module.exports = {
  "task-list": "_task-list_146fc",
  "prefix": "_prefix_146fc"
};
...
var BackButton, CurrentTaskName, DevToolsButton, EditorButton, MinimalUIControls, PrintButton, ReloadButton, ToolButton, ToolbarToggleButton, UIControls;
...
ReloadButton = function () {
  class ReloadButton extends _react.Component {
    render() {
      var onClick;
  ...
  ;
  ReloadButton.contextType = _stateManager.AppStateContext;
  return ReloadButton;
}.call(void 0);
...
exports.UIControls = UIControls = function () {
  class UIControls extends _react.Component {
    render() {
      var className, fullscreen, hasTaskList, selectedTask, toolbarEnabled;
      ({
        hasTaskList,
        selectedTask,
        toolbarEnabled
      ...
      fullscreen = window.screenY === 0 && window.screenTop === 0;
      className = (0, _classnames["default"])({
        fullscreen
      });
      return (0, _hyper["default"])('div.ui-controls', {
        className
      }, [(0, _hyper["default"])('div.left-buttons', [(0, _hyper["default"])(BackButton), (0, _hyper["default"])(CurrentTaskName)]), (0, _hyper["default"])('div.right-buttons', [(0, _hyper["default"])(DevToolsButton), //h ReloadButton
      _hyper["default"]["if"](selectedTask != null)([(0, _hyper["default"])(PrintButton)]), (0, _hyper["default"])('span.separator'), (0, _hyper["default"])(ToolbarToggleButton)])]);
    }
...
},{}],"bundler/dev-bundler.coffee":[function(require,module,exports) {
"use strict";
...
runBundler = function (file, opts) {
  ...
  options = {
    ...
    https: false,
    // Serve files over https or http, defaults to false
    logLevel: 3,
  ...
  bundler = new _parcelBundler["default"](file, options);
...
var _default = runBundler;
exports["default"] = _default;
},{}],"bundler/index.coffee":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.runBundler = void 0;
...
var _devBundler = _interopRequireDefault(require("./dev-bundler"));
...
printLine = function (obj) {
  line;
  var line; // Convert to string if needed
  ...
  return _electron.ipcRenderer.send('bundle-log', line);
};
...
exports.runBundler = runBundler = function (inFile, options = {}) {
  var bundler; // proc.on 'message', (bundle)=>
  //   if (debug) printLine(bundle)

  bundler = (0, _devBundler["default"])(inFile, options);
  return bundler;
};
},{"./dev-bundler":"bundler/dev-bundler.coffee"}],"task/index.coffee":[function(require,module,exports) {
"use strict";
...
var _PacmanLoader = _interopRequireDefault(require("react-spinners/PacmanLoader"));
...
Spinner = function () {
  return (0, _hyper["default"])(_PacmanLoader["default"], {
    size: 20,
    sizeUnit: 'px',
    color: '#aaa'
  });
  ...
  class TaskRenderer extends _react.Component {
    ...
    render() {
      ...
      if (code == null && styles == null) {
        return (0, _hyper["default"])('div.progress', [(0, _hyper["default"])(Spinner), (0, _hyper["default"])('p', "Digesting your code")]);
      }
    ...
    onBundlingFinished(bundle, outDir) {
      ...
      cssFile = bundle.siblingBundlesMap.get("css").name; // Get css and javascript
      ...
      (0, _decache["default"])(compiledCode); //debugger
...
},{"~/hyper":"hyper.coffee","./elements":"task/elements.coffee","./types":"task/types.coffee","../bundler":"bundler/index.coffee"}],"figure-container.coffee":[function(require,module,exports) {
"use strict";
...
var _reactElectronWebView = _interopRequireDefault(require("react-electron-web-view"));
