...
module.exports = {
  "figure-container-outer": "_figure-container-outer_1ff35",
  "figure-container-inner": "_figure-container-inner_1ff35",
  "figure-container": "_figure-container_1ff35",
  "ui-controls": "_ui-controls_1ff35",
  "ui-controls-hidden": "_ui-controls-hidden_1ff35",
  "toolbar-toggle-button": "_toolbar-toggle-button_1ff35",
  "progress": "_progress_1ff35",
  "fullscreen": "_fullscreen_1ff35",
  "left-buttons": "_left-buttons_1ff35",
  "right-buttons": "_right-buttons_1ff35",
  "linear-progress-bar-stripes": "_linear-progress-bar-stripes_1ff35",
  "skeleton-glow": "_skeleton-glow_1ff35",
  "pt-spinner-animation": "_pt-spinner-animation_1ff35"
};
...
module.exports = {
  "task-list": "_task-list_f2cf2",
  "prefix": "_prefix_f2cf2"
};
...
},{}],"bundler.coffee":[function(require,module,exports) {
"use strict";
...
//  Bundler options
exports.createBundler = createBundler = function (file, opts) {
  var bundler, options;
  options = {
    hmr: false,
    outDir: 'dist',
...
exports.TaskRenderer = TaskRenderer = function () {
  class TaskRenderer extends _react.Component {
    ...
    startBundler() {
      ...
      this.bundler = (0, _bundler.createBundler)(codeFile, {
        outDir,
        cacheDir
      });
      ...
      this.bundler.on('error', bundle => {
        return console.log("Bundler error");
      });
    ...
    onBundlingFinished(bundle, outDir) {
      ...
      styles = null;
      cssFile = bundle.siblingBundlesMap.get("css"); // Get css and javascript
...
},{"~/hyper":"hyper.coffee","./elements":"task/elements.coffee","./types":"task/types.coffee","../bundler":"bundler.coffee"}],"figure-container.coffee":[function(require,module,exports) {
"use strict";
