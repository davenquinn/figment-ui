...
const isReactComponent = function (fn) {
  ...
  // conditions are met
  if (fn.propTypes != null) {
    return true
  }
  if (
    fn.prototype != null &&
    fn.prototype.isReactComponent != null &&
    fn.prototype.isReactComponent
  ) {
    return true
  }
  if (fn.isReactComponent != null && fn.isReactComponent) {
    return true
  }
  return false
}
...
class TaskElement extends Component {
  ...
  render() {
    ...
    if (isReactComponent(code)) {
      ...
      return h("div.element-container", [h(code, opts)])
    }
  ...
  runTask() {
    ...
    console.log(code)
    code = unwrapESModule(code)
    if (isValidElement(code) || isReactComponent(code)) {
      return
    }
